...
class RoomState:
    ...
    def __init__(
        self, config: Config, global_state: GlobalState, user_roles: list[Role]
    ):
    ...
    def get_response(self, message: str, mode: str = "CHAT") -> str:
        ...
        system_prompt = chat_system_prompt if mode == "CHAT" else summary_system_prompt
