...
summarize_command_handler = SummarizeCommandHandler(config, global_state, perroom_state_map)
...
@app_commands.describe(language="language", company="company", start_time="Ex: 2023/Q1", end_time="Ex. 2024/Q2")
async def summarize(interaction: discord.Interaction, language: str, company: str, start_time: str, end_time: str):
    await summarize_command_handler.handle_command(interaction, (language, company, start_time, end_time))
